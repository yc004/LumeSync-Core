                ...
                <div className="flex-1 px-6 py-4 space-y-5">
                    ...
                    <div className="border-t border-slate-200 pt-4">
                        ...
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-sm text-slate-700 font-medium">截图间隔</span>
                            <span className="text-sm font-mono text-slate-600">{monitorIntervalValue}s</span>
                        </div>
                        <input
                            type="range"
                            min="0.5"
                        ...
                        <div className="flex items-center justify-between mt-2">
                            <span className="text-xs text-slate-500">0.5s</span>
                            <button
